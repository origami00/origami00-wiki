...
export const socialLinks: SocialLink[] = [
  {
    ...
    color: "#5a9e8f",
    iconSrc: "/static/icon/github-fill.png",
  },
  {
    label: "Bilibili",
    icon: "Tv",
    ...
    color: "#6ebeaf",
    iconSrc: "/static/icon/BILIBILI_LOGO.png",
  },
  {
    label: "抖音",
    icon: "Music2",
...
export const photoWallItems: PhotoWallItem[] = [
  { title: "封面", src: "/static/照片墙资产/23417_86777360146.jpg" },
  { title: "插画1", src: "/static/照片墙资产/baimaomeimo.jpg" },
  { title: "风格参考", src: "/static/照片墙资产/fenggecankao.jpg" },
  { title: "房间布局", src: "/static/照片墙资产/beijin.jpg" },
  { title: "背景", src: "/static/照片墙资产/beijin2.jpg" },
  { title: "花卉", src: "/static/照片墙资产/flower-9294773_1280.webp" },
  { title: "随拍", src: "/static/照片墙资产/12342_22260975244.jpg" },
  { title: "插画2", src: "/static/照片墙资产/280518dc-3ccf-485e-aa44-52e6a7c54f99.webp" },
  { title: "线稿", src: "/static/照片墙资产/youhuxiantiao.jpg" },
];
